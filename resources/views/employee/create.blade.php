...
@section('body')
    <h1 class="h5 mb-4 text-center font-weight-bold">Add new Employee</h1>
    <div class="row mt-4 justify-content-center align-items-center">
        <div class="col-10 col-md-10 col-lg-6 col-xl-6">
            <div class="card card-body border-0 shadow mb-4">

                <form action="{{route('employees.store')}}" class="mt-4" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input class="form-control" id="number" name="phone" type="number" placeholder="Contact Number" required>
                            </div>
                            <div class="form-group mt-1">
